...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_destroy", DestroyBuilding, ADMFLAG_UNBAN, "sm_destroy <#userid|name> [sentry/dispenser/entrance/exit/all/last]");
	RegAdminCmd("sm_destroybuildings", DestroyBuilding, ADMFLAG_CUSTOM2, "sm_destroy <#userid|name> [sentry/dispenser/entrance/exit/all/last]");
