...
public OnPluginStart() {
	...
	RegAdminCmd("sm_kartify", Command_Kartify, ADMFLAG_UNBAN, "Put players into karts!");
	RegAdminCmd("sm_kart", Command_Kartify, ADMFLAG_UNBAN, "Put players into karts!");
	RegAdminCmd("sm_unkartify", Command_Unkartify, ADMFLAG_UNBAN, "Remove players from karts");
	RegAdminCmd("sm_unkart", Command_Unkartify, ADMFLAG_UNBAN, "Remove players from karts");
	RegAdminCmd("sm_kartifyme", Command_KartifyMe, ADMFLAG_CUSTOM2, "Puts you into a kart!");
	RegAdminCmd("sm_kartme", Command_KartifyMe, ADMFLAG_CUSTOM2, "Puts you into a kart!");
	RegAdminCmd("sm_unkartifyme", Command_UnkartifyMe, ADMFLAG_CUSTOM2, "Removes you from a kart");
	RegAdminCmd("sm_unkartme", Command_UnkartifyMe, ADMFLAG_CUSTOM2, "Removes you from a kart");
