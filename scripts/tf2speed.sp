...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_speed", Command_SetSpeed, ADMFLAG_UNBAN, "Set target(s) speed, Usage: sm_setspeed \"target\" \"speed\"");
	RegAdminCmd("sm_resetspeed", Command_ResetSpeed, ADMFLAG_UNBAN, "Reset target(s) speed, Usage: sm_resetspeed \"target\"");
	RegAdminCmd("sm_unsetspeed", Command_ResetSpeed, ADMFLAG_UNBAN, "Reset target(s) speed, Usage: sm_unsetspeed \"target\"");
...
public Action:Command_SetSpeed(client, args)
{
	if(args != 2)
	{
		ReplyToCommand(client, "[SM] Usage: sm_speed \"target\" \"speed\"");
