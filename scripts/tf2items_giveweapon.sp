...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_giveweapon", Command_Weapon, ADMFLAG_ROOT, "sm_giveweapon <player> <itemindex>");
	RegAdminCmd("sm_giveweapon_ex", Command_WeaponEx, ADMFLAG_ROOT, "Give Permanent Weapon sm_giveweapon_ex <player> <itemindex>");
	RegAdminCmd("sm_ludmila", Command_GiveLudmila, ADMFLAG_ROOT, "Give Ludmila to yourself using sm_ludmila");
	RegAdminCmd("sm_glovesofrunning", Command_GiveGlovesofRunning, ADMFLAG_ROOT, "Give the Gloves of Running Urgently to yourself using sm_gloves or sm_glovesofrunning");
	RegAdminCmd("sm_spycrabpda", Command_GiveSpycrabPDA, ADMFLAG_ROOT, "Give the Spycrab PDA to yourself with sm_spycrabpda or sm_spycrab");
	RegAdminCmd("sm_gloves", Command_GiveGlovesofRunning, ADMFLAG_ROOT, "Give the Gloves of Running Urgently to yourself using sm_gloves or sm_glovesofrunning");
	RegAdminCmd("sm_spycrab", Command_GiveSpycrabPDA, ADMFLAG_ROOT, "Give the Spycrab PDA to yourself with sm_spycrabpda or sm_spycrab");
	RegAdminCmd("sm_givew", Command_Weapon, ADMFLAG_ROOT, "sm_givew <player> <itemindex>");
	RegAdminCmd("sm_givew_ex", Command_WeaponEx, ADMFLAG_ROOT, "Give Permanent Weapon sm_givew_ex <player> <itemindex>");
	RegAdminCmd("sm_addwearable", Command_AddWearable, ADMFLAG_ROOT, "Add a wearable weapon to a player sm_addwearable <player> <itemindex>");
	RegAdminCmd("sm_addwr", Command_AddWearable, ADMFLAG_ROOT, "Add a wearable weapon to a player sm_addwearable <player> <itemindex>");
	RegAdminCmd("tf2items_giveweapon_reload", Command_ReloadCustoms, ADMFLAG_ROOT, "Reloads custom items list");
	RegAdminCmd("sm_resetex", Command_ResetEx, ADMFLAG_ROOT, "Reset the Permanent Weapons of a Player sm_resetex <target>");
	RegAdminCmd("sm_gimme", Command_Gimme, ADMFLAG_ROOT, "Give self a weapon sm_gimme <itemindex>");
