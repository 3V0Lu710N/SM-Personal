...
{
	RegAdminCmd("sm_fakeitem", PrintFakeItem, ADMFLAG_ROOT, "Prints a fake item message to chat");
	RegAdminCmd("sm_fakeitem2", PrintFakeItem2, ADMFLAG_ROOT, "Prints a fake item message to chat");
