...
public OnPluginStart()
{
	...
	g_Cvarsteamids = CreateConVar("sm_auto_bhop_steamid", "", "Steam ID that can be used for autobhop, comma delimited. (example: STEAM:0:0:1234567,STEAM:0:0:1234567,STEAM:0:0:1234567)");
	RegConsoleCmd("sm_bhop", Command_AutoBunny);
